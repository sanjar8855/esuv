...
{{--                        </div>--}}
	...
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-1"><path d="M9 6l6 6l-6 6" /></svg>`,
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="validity_period" id="validity_period" value="{{ $waterMeter->validity_period }}" class="form-control" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-icon">
                                ...
                                <input name="expiration_date" value="{{ $waterMeter->expiration_date }}" class="form-control" placeholder="Sanani tanlang" id="datepicker-icon-prepend3"/>
                            </div>
                            <script>
                                document.addEventListener("DOMContentLoaded", function () {
                                    window.Litepicker && (new Litepicker({
	...
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-1"><path d="M9 6l6 6l-6 6" /></svg>`,
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-icon">
                                ...
                                <input value="{{ $waterMeter->last_reading_date }}" name="last_reading_date" class="form-control" placeholder="Sanani tanlang" id="datepicker-icon-prepend2"/>
                            </div>
                            <script>
                                document.addEventListener("DOMContentLoaded", function () {
                                    window.Litepicker && (new Litepicker({

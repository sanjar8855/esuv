        ...
        <div class="container-xl">
            <div class="row row-cards">
                <div class="col-12">
                    ...
                    <form action="{{ route('customers.import.handle.no_meter') }}" method="POST" enctype="multipart/form-data">
                        <h1>Meyoriy</h1>
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="excel_file" id="excel_file_no_meter" class="form-control" required>
                                    <small class="form-hint">
                                        <a href="#" download>Shablonni yuklab oling.</a> <br>
                                        <b>Majburiy ustunlar:</b> kompaniya_id, kocha_id, fio, hisob_raqam, oila_azolari.
                                    </small>
                                </div>
                            </div>
                    ...
                    <form action="{{ route('customers.import.handle.with_meter') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="excel_file" class="form-label">Excel Faylni Tanlang (.xlsx, .xls, .csv)</label>
                                    <input type="file" name="excel_file" id="excel_file_with_meter" class="form-control" required>
                                    <small class="form-hint">

        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function toggleFields() {
                if (hasWaterMeterCheckbox.checked) {
                    ...
                    // ✅ Oila a'zolari soni ixtiyoriy
                    familyMembersInput.removeAttribute('required');
                    familyMembersInput.value = "";
                } else {
                    // ✅ Hisoblagich yo'q (meyoriy)
                    if (meterNumberDiv) {
                        meterNumberDiv.style.display = "none";
                    }
                    // ✅ Oila a'zolari soni MAJBURIY
                    familyMembersInput.setAttribute('required', 'required');
                }
            }

            hasWaterMeterCheckbox.addEventListener("change", toggleFields);
            toggleFields(); // Sahifa yuklanganda
        });
    </script>
    <script>
        document.addEventListener("DOMContentLoaded", function () {

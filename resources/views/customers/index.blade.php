                ...
                <div class="col-12">
                    ...
                    <form method="GET" class="mb-3">
                        <div class="input-group">
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="Mijoz ismi, telefoni yoki hisob raqami" class="form-control">
                        ...
                        <div class="input-group">
                            <select name="street_id" class="form-control">
                                ...
                                @foreach($streets as $street)
                                    <option value="{{ $street->id }}" {{ request('street_id') == $street->id ? 'selected' : '' }}>
                                        {{ $street->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <form method="GET" class="mb-3">
                        <div class="input-group">
                            <select name="debt" class="form-control">
                                ...
                                <option value="has_debt" {{ request('debt') == 'has_debt' ? 'selected' : '' }}>Faqat qarzdorlar</option>
                            </select>
                            <button type="submit" class="btn btn-primary">Filtrlash</button>
                        </div>
                    </form>
                    ...
                    <table class="table table-bordered mt-3">
                        ...
                        @foreach($customers as $customer)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('customers.show', $customer->id) }}" class="btn btn-info btn-sm">Ko‘rish</a>
                                    <a href="{{ route('customers.edit', $customer->id) }}" class="btn btn-warning btn-sm">Tahrirlash</a>

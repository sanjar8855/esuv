...
<header class="navbar navbar-expand-lg navbar-transparent py-3">
    <div class="container">
        <a href="{{ route('home') }}" class="navbar-brand navbar-brand-autodark">
            ...
            {{--            </svg>--}}
{{--            eSuv.uz--}}
            <img src="{{ asset('tabler/img/logo/dark-blue.png') }}" alt="" width="100">
        </a>
        <button
                    ...
                    <div id="carousel-controls" class="carousel slide" data-bs-ride="carousel" data-interval="4000">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset('tabler/img/hero/tez-va-qulay.png') }}" class="img d-block mx-auto"
                                     alt="">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('tabler/img/hero/suv-nazorati.png') }}"
                                     class="img d-block mx-auto" alt="">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('tabler/img/hero/bot.png') }}"
                                     class="img d-block mx-auto" alt="">
                            </div>
                        </div>
...
{{--<section class="section section-light mt-4 pt-4">--}}
...
<section class="section">
    <div class="container">
        <div class="row justify-content-lg-center">
            <h1 class="text-center">Loyiha ko'rsatgichlari</h1>
                    ...
                    <div class="row justify-center">
                        <div class="col-auto">
                            <ul class="list-inline list-inline-dots">
                                {{--                                <li class="list-inline-item">--}}
                                {{--                                    <a class="link-muted" href="/terms-of-service">Terms of service</a>--}}
                                {{--                                </li>--}}
                                <li class="list-inline-item">
                                    <a class="link-muted" href="https://t.me/rtm_margilan">RTM Team</a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<!-- Libs JS -->
<script src="{{ asset('tabler/libs/typed.js/dist/typed.umd.js') }}" defer></script>

                ...
                <ul class="navbar-nav pt-lg-3">
                    ...
                    <li class="nav-item {{ request()->routeIs('regions*') || request()->routeIs('cities*') || request()->routeIs('neighborhoods*') || request()->routeIs('streets*') ? 'active' : '' }} dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item {{ request()->routeIs('regions*') ? 'active' : '' }}" href="{{ route('regions.index') }}">
                                Viloyatlar
                            </a>
                            <a class="dropdown-item {{ request()->routeIs('cities*') ? 'active' : '' }}" href="{{ route('cities.index') }}">
                                Shaharlar
                            </a>
                            <a class="dropdown-item {{ request()->routeIs('neighborhoods*') ? 'active' : '' }}" href="{{ route('neighborhoods.index') }}">
                                Mahallalar
                            </a>
                            <a class="dropdown-item {{ request()->routeIs('streets*') ? 'active' : '' }}" href="{{ route('streets.index') }}">
                                Ko'chalar
                            </a>
                        </div>
                    </li>
